...
from aoc23.day_01_01 import day_01_first_last_digit, day_01_sum_calibration_values
...
class TestAocDay01Tests(unittest.TestCase):
    ...
    def test_day_01_should_sum_values(self):
        assert day_01_sum_calibration_values(["1abc2", "pqr3stu8vwx", "a1b2c3d4e5f", "treb7uchet"]) == 142
